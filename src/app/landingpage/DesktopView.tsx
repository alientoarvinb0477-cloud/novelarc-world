...
import Crosshair from "../../components/world/Crosshair"; // Fixed import path
    ...
    <main className="relative w-full h-screen flex flex-col items-center justify-center overflow-hidden bg-black">
      ...
      <div className="max-w-4xl text-center space-y-12 relative z-10">
        <div className="space-y-4">
          <h1 className="text-7xl sm:text-8xl md:text-[10rem] font-black tracking-tighter leading-none select-none text-white">
            NOVELARC<br />
            <span className="italic font-thin text-stone-600">WORLD</span>
          </h1>
          <div className="flex justify-center items-center gap-6 py-2">
            <div className="h-[1px] w-16 bg-stone-800" />
            <p className="text-stone-500 font-sans text-[10px] font-bold uppercase tracking-[0.6em]">Immersive OS</p>
            <div className="h-[1px] w-16 bg-stone-800" />
          </div>
        </div>
      ...
      <footer className="absolute bottom-10 w-full flex justify-center pointer-events-none opacity-20">
        <div className="font-sans text-[9px] font-bold uppercase tracking-[0.8em] text-stone-500">ARC-V1 • 2026</div>
      </footer>
    </main>
  );
}
